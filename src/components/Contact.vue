    ...
    <div class="max-w-7xl mx-auto">
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-200 max-w-2xl mx-auto">
          Have questions about our perfumes? Our fragrance experts are here to
          help you.
        </p>
      </div>
          ...
          <form class="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                id="message"
                class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                placeholder="Share your fragrance needs ..."
              ></textarea>
            </div>
            <button
            ...
            <div class="space-y-6">
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-800">+234 798 456-6789</p>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-800">contact@fraghaven.com</p>
                  <p class="text-gray-600">support@fraghaven.com</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-800">56B Bourdillon Road</p>
                  <p class="text-gray-600">Lagos, Nigeria 100001</p>
                </div>
              </div>
            </div>
            <div class="mt-24">

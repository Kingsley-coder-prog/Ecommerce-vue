          ...
          >
            <label class="relative w-full">
              <input
                type="text"
                placeholder="Search ..."
                class="w-full px-3 py-4 text-xs border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
    ...
    <nav class="bg-pink-950" aria-label="Main navigation">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section
          ...
          class="md:hidden mt-2 bg-white rounded-lg shadow-md p-4 space-y-3 text-[#504037] text-center"

      ...
      <div class="flex flex-col lg:flex-row gap-12 mb-20">
        ...
        <div class="lg:w-1/2">
          <div class="relative rounded-2xl overflow-hidden h-96 shadow-xl">
            ...
            <div class="absolute bottom-0 left-0 p-6 text-white">
              <h3 class="text-2xl font-bold">Since 2022</h3>
        ...
        <div class="lg:w-1/2 flex flex-col justify-center">
          ...
          <p class="text-lg text-gray-600 mb-4">
            At Fragrance Haven, we believe in the power of scent to evoke
            emotions and create lasting memories. Our curated collection of
            luxury perfumes is designed to cater to diverse tastes and
            preferences.
          </p>
